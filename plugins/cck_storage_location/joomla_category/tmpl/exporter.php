...
require_once JPATH_SITE.'/plugins/cck_storage_location/joomla_category/classes/exporter.php';
$options	=	plgCCK_Storage_LocationJoomla_Category_Exporter::getColumnsToExport();
