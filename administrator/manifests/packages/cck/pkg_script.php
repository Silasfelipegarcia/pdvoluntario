...
class pkg_cckInstallerScript
{
	...
	function postflight( $type, $parent )
	{
		...
		<p>
		<a target="_blank" href="https://www.seblod.com/store" class="btn btn-small btn-success"><?php echo $texts[7]['str']; ?></a>
		<a target="_blank" href="https://www.seblod.com/resources/manuals" class="btn btn-small btn-primary"><?php echo $texts[6]['str']; ?></a>
		<a target="_blank" href="https://www.seblod.com/changelogs" class="btn btn-small"><?php echo $texts[3]['str']; ?></a>
		<a target="_blank" href="https://www.seblod.com/resources/videos" class="btn btn-small"><?php echo $texts[4]['str']; ?></a>
		</p><br />
